...
const config = {
  title: 'IBM Software Networking Porfolio',
  tagline: 'Software Networking Porfolio Tools',
  ...
  baseUrl: '/software-networking-pot/',
  deploymentBranch: "main",
  
  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'IBM/steve-plotkin', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Software Networking Porfolio',
        logo: {
          alt: '',
          src: '/images/ibm-watson-logo.png',
        },
        items: [
          {
            type: 'doc',
